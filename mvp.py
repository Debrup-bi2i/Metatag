...
#st.table(df)
st.table(df.style.applymap(color_green,pd.IndexSlice[:,['bu','web_section_id','page_content','segment','lifecycle','user_profile','simple_title']]).applymap(color_green_1,pd.IndexSlice[:,['sub_bu','analytics_template_name','product_service_name','analytics_section']]))
